...
#define STRING_CONFIG_H_AUTHOR "(Eddie, Delta)" // Who made the changes.
...
#define CUSTOM_MENDEL_NAME "GET delta pro"
...
#define ENABLE_AUTO_BED_LEVELING // Delete the comment to enable (remove // at the start of the line)
  ...
  #define DELTA_PROBABLE_RADIUS (DELTA_PRINTABLE_RADIUS*0.35)
...
#define MANUAL_Z_HOME_POS 10// For delta: Distance between nozzle and print surface after homing.

//// MOVEMENT SETTINGS
#define NUM_AXIS 4 // The axis order in all axis related arrays is X, Y, Z, E

// delta homing speeds must be the same on xyz
#define HOMING_FEEDRATE {200*20, 200*20, 200*20, 0}  // set the homing speeds (mm/min)
